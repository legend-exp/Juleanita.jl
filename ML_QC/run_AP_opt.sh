...
srun -n 1 -c 256 --cpu_bind=cores /global/common/software/nersc/n9/julia/1.10.4/bin/julia --project=/global/homes/l/lschl/.julia/environments/asic-dev/ ./01_AP_hyperpars_opt.jl
